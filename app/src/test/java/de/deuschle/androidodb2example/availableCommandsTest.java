...
public class availableCommandsTest {
    ...
    public void testSingleValue() {
        ...
        try{
            assertFalse(availableCommands.getAvailability("22", audi_20));
        } catch (Exception e){
            fail();
        }
    ...
    public void testSingleValueException() throws Exception {
        ...
        availableCommands.getAvailability("22", audi_00);
    }
    ...
    public void testAvailabilityMap() {
        ...
        HashMap<String, Boolean> availabilityMap = availableCommands.getAvailabilityMap(audi, 0);
    ...
    public void testHexToBin() {
        ...
        assertEquals("01111010000111000000000000000000",availableCommands.hexToBin(toyota_1_40));
    }
